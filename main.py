...
# Imports based on your project structure (as seen in the screenshot):
from src.logger import setup_logger           # Imported from src/logger.py
from src.load_csv import load_dataset         # Imported from src/load_csv.py
from src.column_to_numeric import safe_convert_to_numeric # Imported from src/column_to_numeric.py
...
def main():
    ...
    try:
        ...
        # Note: Ensure 'bmi' is the correct column name in your CSV
